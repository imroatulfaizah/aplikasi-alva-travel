            ...
            <table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan Grafik Batang Perjalanan Tiap Kota</td>
                        <td style="text-align:center;">
                        <a class="btn btn-sm btn-default" href="<?php echo base_url(); ?>backend/grafik/lihat_grafik_batang">Lihat Grafik</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center;vertical-align:middle">3</td>
                        <td style="vertical-align:middle;">Laporan Grafik Lingkaran Perjalanan Tiap Kota</td>
                        <td style="text-align:center;">
                        <a class="btn btn-sm btn-default" href="<?php echo base_url(); ?>backend/grafik/lihat_grafik_pie">Lihat Grafik</a>
                        </td>
                    </tr>
                </tbody>
            </table>
