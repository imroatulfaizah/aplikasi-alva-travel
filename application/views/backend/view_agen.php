    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Kode agen [<?php echo $agen['kd_agen']; ?>]  </h6>
        </div>
        <div class="card-body">             
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <p>Nama agen : <b> <?php echo $agen['nama_agen']?>]</b></p>
                  <p>Alamat agen: <b><?php echo strtoupper($agen['alamat_agen']) ?></b></p>
                  <p>No. HP : <b><?php echo $agen['hp_agen']; ?></b></p>
                  <p>Status agen    : <?php if ($agen['status_agen'] == '1') { ?>
                    <td class="btn-success"> Online</td> 
                    <?php } else { ?>
                    <td class="btn-danger">Offline</td>
                  <?php } ?></b></p>
                  <!-- <p>Keterengan : <b><?php echo $agen['desc_agen'] ?></b></p> -->
                </div>
                <div class="col-sm-6">
                </div>
            </div>
