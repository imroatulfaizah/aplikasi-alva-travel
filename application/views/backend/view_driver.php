    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Kode driver [<?php echo $driver['kd_driver']; ?>]  </h6>
        </div>
        <div class="card-body">             
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <p>Nama driver : <b> <?php echo $driver['nama_driver']?>]</b></p>
                  <p>Alamat driver: <b><?php echo strtoupper($driver['alamat_driver']) ?></b></p>
                  <p>No. HP : <b><?php echo $driver['hp_driver']; ?></b></p>
                  <p>Status driver    : <?php if ($driver['status_driver'] == '1') { ?>
                    <td class="btn-success"> Online</td> 
                    <?php } else { ?>
                    <td class="btn-danger">Offline</td>
                  <?php } ?></b></p>
                  <!-- <p>Keterengan : <b><?php echo $driver['desc_driver'] ?></b></p> -->
                </div>
                <div class="col-sm-6">
                </div>
            </div>
            ...
            <button data-toggle="modal" data-target="#edit" class="btn btn-primary pull-rigth">Edit Status</button>
          </div>
      </div>
    </div>
  </div>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="<?php echo base_url('backend/driver/editstatus') ?>" method="post" enctype="multipart/form-data">
									<div class="card-body">
										<div class="row">
											<div class="col-sm-14">
