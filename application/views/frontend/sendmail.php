			...
			<tr>
				<td colspan="2">
					<p style="text-align: justify; padding: 10px;">
						Dear Customer Alva Travel,<br>
						Terima kasih telah menggunakan Alva Travel.
					</p>
					<p style="text-align: justify; padding: 10px;">
						...
						<tr>
							...
							<tr>
								<td colspan="2">
									<p style="padding:10px;">
										<br>
										Hormat Kami,<br>
										<span style="color:#fd7521;"><strong>Alva Travel</strong></span>
										<br>
										<br>
									</p>
								</td>
							...
							<tr class="footer" style="font-size: 10px; background-color: #484B51;color:#ffffff;">
								<td style="padding-left:10px; padding-right:10px;">
									<?php echo date("Y"); ?> &copy; Alva Travel
								</td>
