				...
				<div class="row">
						...
						<div class="card mb-5">
							...
							<div class="card-body">
								...
								<form action="<?php echo base_url() ?>tiket/cekjadwal?>" method="get">
									...
									<div class="form-group">
										<label for="exampleInputEmail1">Asal <b>(Saat Ini Baru Tersedia Pemberangkatan dari Malang)</b></label>
										...
										<select name="asal" class="form-control js-example-basic-single" required >
											...
											<option value="<?php echo $row['kd_tujuan'] ?>"><?php echo strtoupper($row['kota_tujuan'])?> </option>
											<?php } ?>
										</select>
										<!-- </div> -->
									</div>
					...
					<div class="col-lg-8">
						<div class="card mb-10">
							<div class="card-header">
								<i class="fa fa-info"></i> Info Kota
							</div>
							<div class="card-body">
